      ...
      <main className="min-h-screen p-8">
        <div className="mb-10 flex items-end justify-between">
          ...
          <div className="flex gap-2">
            <button className="rounded-lg bg-surface-container-low p-2 text-slate-400 transition-all hover:text-primary">
              <span className="material-symbols-outlined">grid_view</span>
            </button>
            <button className="rounded-lg bg-surface-container-high p-2 text-primary transition-all">
        ...
        <div className="flex gap-6">
          <section className="flex flex-1 flex-col gap-6">
            <div className="group flex cursor-pointer flex-col items-center justify-center rounded-2xl border-2 border-dashed border-outline-variant/50 bg-surface-container-low/30 p-10 transition-all hover:border-primary/50 hover:bg-primary/5">
              ...
              <table className="w-full border-collapse text-left">
                ...
                <tbody className="divide-y divide-outline-variant/10">
                  {files.map((file) => (
                    <tr
                      key={file.name}
                      className={`${file.selected ? "border-l-4 border-primary bg-primary/10" : ""} group transition-colors hover:bg-white/5`}
                    >
                      ...
                      <td className="px-6 py-4 text-right">
                        <span className={`material-symbols-outlined cursor-pointer transition-all ${file.selected ? "text-primary" : "text-slate-500 opacity-0 group-hover:opacity-100 hover:text-white"}`}>
          ...
          <aside className="flex w-80 flex-col gap-6">
            <div className="glass-panel rounded-2xl border border-outline-variant/20 p-6">
              ...
              <div className="mt-8 space-y-6">
                ...
                <div>
                  ...
                  <button className="mt-6 flex w-full items-center justify-center gap-2 rounded-lg py-2 text-xs font-bold text-primary transition-colors hover:bg-primary/10">
            ...
            <div className="rounded-2xl border border-primary/20 bg-gradient-to-br from-surface-container-low to-surface-container-high p-6">
